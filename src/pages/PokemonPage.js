        ...
        <Row>
          <Col xs= {12} sm= {12} md= {12} lg= {12} xl = {12}>
            <Card className= 'p-3 rounded text-center shadow mb-5 bg-white' style= {{border: 'none'}}>
              <Link to= {`/pokemon-react/pokemon/${pokemonDetails.id}`}>
              ...
              <Link to= {`/pokemon-react/pokemon/${pokemonDetails.id}`} className= 'link-name text-dark fs-2'  style= {{textDecoration: 'none'}}>
                <Card.Title as= 'div'>
                  <strong>
